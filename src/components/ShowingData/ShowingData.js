        ...
        <Tab.Container defaultActiveKey="businessDevelopment">
          <Row>
            ...
            <Col>
              <div className="mb-3">
                <Button
                  onClick={() => navigate("/db/viewPDF")}
                  className="rt-btn-on mb-2"
                >
                  PDF View
                </Button>
                ...
                {bdData && mData && okrData ? (
                  <>
                    ...
                    <Tab.Pane eventKey="marketing">
                      ...
                      <pre>{contentPlan?.basicChecklist}</pre>

                      <h4 className="rt-result-hading brand-color p-4">
                        {mDataFull?.seoTitle2}
                      </h4>
                      <pre>{contentPlan?.keywordResearch}</pre>

                      <h4 className="rt-result-hading brand-color p-4">
                        {mDataFull?.seoTitle3}
                      </h4>
                      <pre>{contentPlan?.technicalSEO}</pre>

                      <h4 className="rt-result-hading brand-color p-4">
                        {mDataFull?.seoTitle4}
                      </h4>
                      <pre>{contentPlan?.onPage}</pre>

                      <h4 className="rt-result-hading brand-color p-4">
                        {mDataFull?.seoTitle5}
                      </h4>
                      <pre>{contentPlan?.offPage}</pre>
                    </Tab.Pane>
